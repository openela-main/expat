...
# https://issues.redhat.com/browse/RHEL-177992
# https://github.com/libexpat/libexpat/pull/1216
Patch0: expat-2.7.3-CVE-2026-45186.patch

# https://issues.redhat.com/browse/RHEL-220983
# https://github.com/libexpat/libexpat/pull/1246
Patch1: expat-2.7.3-CVE-2026-50219.patch

# https://issues.redhat.com/browse/RHEL-221017
# https://github.com/libexpat/libexpat/pull/1272
Patch2: expat-2.7.3-CVE-2026-56132.patch
...
* Fri Jun 21 2024 František Hrdina <fhrdina@redhat.com>
...
* Mon Oct 31 2022 Tomas Korbar <tkorbar@redhat.com>
- Rebase to 2.5.0

* Thu Sep 29 2022 Tomas Korbar <tkorbar@redhat.com>
- Rebase to 2.4.9

* Thu Jul 21 2022 Fedora Release Engineering <releng@fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Thu Apr 28 2022 Frantisek Hrdina <fhrdina@redhat.com>
...
* Fri Apr 08 2022 Tomas Korbar <tkorbar@redhat.com>
- Rebase to version 2.4.8

* Mon Mar 07 2022 Tomas Korbar <tkorbar@redhat.com>
- Rebase to version 2.4.7

* Mon Feb 21 2022 Tomas Korbar <tkorbar@redhat.com>
- Rebase to version 2.4.6

* Mon Jan 31 2022 Tomas Korbar <tkorbar@redhat.com>
- Rebase to version 2.4.4

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Tue Jan 18 2022 Tomas Korbar <tkorbar@redhat.com>
- Change specfile according to Sebastian Pippings suggestions

* Mon Jan 17 2022 Tomas Korbar <tkorbar@redhat.com>
- Rebase to version 2.4.3

* Wed Jul 21 2021 Fedora Release Engineering <releng@fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Tue Jun 01 2021 Tomas Korbar <tkorbar@redhat.com>
- Rebase to 2.4.1 Resolves: rhbz#1963400

* Thu Apr 15 2021 Tomas Korbar <tkorbar@redhat.com>
- Rebase to 2.3.0 Resolves: rhbz#1942794

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Thu Dec 24 2020 Robert Scheck <robert@fedoraproject.org>
- Spec file cleanup

* Fri Dec 18 2020 Tom Stellard <tstellar@redhat.com>
- Add BuildRequires: make

* Fri Nov 13 2020 Joe Orton <jorton@redhat.com>
...
* Mon Sep 16 2019 Joe Orton <jorton@redhat.com>
- update to 2.2.8 (#1752167) Resolves: rhbz#1752167

* Thu Jul 25 2019 Fedora Release Engineering <releng@fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Thu Jun 27 2019 Joe Orton <jorton@redhat.com>
...
* Wed Aug 15 2018 Joe Orton <jorton@redhat.com>
- update to 2.2.6
...
* Sat Feb 03 2018 Igor Gnatenko <ignatenkobrain@fedoraproject.org>
- Switch to %%ldconfig_scriptlets

* Thu Nov 02 2017 Joe Orton <jorton@redhat.com>
- update to 2.2.5 (#1508667) Resolves: rhbz#1508667

* Fri Oct 13 2017 Bruno Goncalves <bgoncalv@redhat.com>
- Add CI tests using the standard test interface

* Mon Aug 21 2017 Joe Orton <jorton@redhat.com>
- update to 2.2.4 (#1483359) Resolves: rhbz#1483359

* Fri Aug 04 2017 Joe Orton <jorton@redhat.com>
- Collapse changelog

* Fri Aug 04 2017 Joe Orton <jorton@redhat.com>
- fix tests with unsigned char (upstream PR 109) Resolves: rhbz#1473266

* Thu Aug 03 2017 Joe Orton <jorton@redhat.com>
...
* Fri Jul 14 2017 Joe Orton <jorton@redhat.com>
